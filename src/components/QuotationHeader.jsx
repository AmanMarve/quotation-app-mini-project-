...
const QuotationHeader = () => {
  return (
    <div className="border-b border-black">
      ...
      <div className="flex flex-row -mt-5 sm:flex-row justify-center items-center gap-1 sm:gap-2">
      ...
      <p className="text-center text-sm sm:text-xl italic -mt-1 -sm:mt-1">
        Sales & Services
      </p>

      <p className="border-t p-1 italic font-bold border-black text-center text-[10px] sm:text-base">
